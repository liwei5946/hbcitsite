...
public class SendRedirectNewsEditServlet extends HttpServlet {
	 ...
	 */
	public SendRedirectNewsEditServlet() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//request.getRequestDispatcher("/admin/admin_news_editNew.jsp").forward(request, response);
